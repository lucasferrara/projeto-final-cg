...
function main() {
    ...
    function render(time) {
        ...
        const skinColor = [0.95, 0.8, 0.7, 1.0];   // Pele mais clara
        const shirtColor = [0.8, 0.1, 0.1, 1.0];   // Camisa Vermelha
        const pantsColor = [0.3, 0.3, 0.3, 1.0];   // Calça Cinza Escuro
        const bootsColor = [0.1, 0.1, 0.1, 1.0];   // Botas Pretas
        const hairColor = [0.9, 0.8, 0.2, 1.0];    // Cabelo Loiro/Amarelo
        const eyeWhiteColor = [1.0, 1.0, 1.0, 1.0];
        const eyePupilColor = [0.0, 0.6, 0.0, 1.0]; // Olhos Verdes
        const mouthColor = [0.5, 0.2, 0.2, 1.0];
